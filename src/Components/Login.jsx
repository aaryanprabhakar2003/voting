 ...
 <div>
  <div className="mx-auto flex max-w-4xl items-center bg-white p-4 font-[sans-serif] text-gray-800 md:h-screen">
    <div className="grid items-center overflow-hidden rounded-xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] md:grid-cols-3">
      ...
      <form className="w-full px-6 py-6 sm:px-16 md:col-span-2 grid grid-cols-1 gap-y-4">
        <div className="mb-6">
        ...
        <div className="space-y-5">
          ...
          <div>
            <label className="mb-2 block text-sm font-bold">Email Id:</label>
            <div className="relative flex items-center">
              <input
                name="email"
                type="email"
          ...
          <div>
            <label className="mb-2 block text-sm font-bold">Adhaar Number:</label>
            <div className="relative flex items-center">
              <input
